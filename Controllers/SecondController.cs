...
// ============================================================================================================
        ...
        public IActionResult Index()
        {
            ...
            List<Auction> AllAuctions = _context.Auctions.OrderBy(a => a.EndDate).Include(a => a.User).Include(a =>a.Biders).ToList();
...
// ============================================================================================================
        ...
        public IActionResult PlaceBid(double myBid, int AuctionId, int BidId)
        {
            ...
            Bid CurrentBid = _context.Bids.Include(b => b.User).Include(b => b.Auction).Single(b => b.BidId == BidId);
            ...
            CurrentBid.User.Wallet += CurrentBid.TopBid;
